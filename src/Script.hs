...
data Loc
  ...
  deriving (Eq, Show, Ord, Generic, Serialize, Hash.Hashable, FromJSON, ToJSON)
...
newtype Name = Name { unName :: Text }
  deriving (Eq, Show, Ord, Generic, Hash.Hashable, B.Binary, Serialize, FromJSONKey, ToJSONKey)
...
data Pattern
  = PatLit EnumConstr
  deriving (Eq, Ord, Show, Generic, Hash.Hashable, FromJSON, ToJSON)
...
data Value
  ...
  | VAccount Addr    -- ^ Account Address
  | VAsset Addr        -- ^ Asset Address
  | VContract Addr  -- ^ Contract Address
...
data TCollection
  ...
  deriving (Eq, Ord, Show, Generic, Hash.Hashable, Serialize, FromJSON, ToJSON)
...
data EnumDef = EnumDef
  ...
  } deriving (Eq, Ord, Show, Generic, Hash.Hashable, ToJSON, FromJSON)
...
data Place
  ...
  | PlaceEnd
  deriving (Eq, Ord, Show, Generic, Serialize, Hash.Hashable, ToJSON, FromJSON, FromJSONKey, ToJSONKey)
