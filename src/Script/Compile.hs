...
putScript :: Script -> Maybe Storage.Storage -> Text -> PutM ()
...
getScript :: Get (Script, Maybe Storage.Storage, Text)
getScript = do
  -- Storage
...
readScript :: ByteString -> Either [Char] (Script, Maybe Storage.Storage, Text)
...
writeScript :: Script -> Maybe Storage.Storage -> Text -> ByteString
